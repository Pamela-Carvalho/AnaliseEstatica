          ...
          <div class="modal-content modal-content-feed two">
            ...
            <form name="formReport">
              ...
              <div class="modal-body modal-body-feed two">
                <label for="motive-denounces-{{ $post->id_publicacao }}">{{ __('Por que deseja denunciar essa publicação') }}?</label>
                <textarea name="motive-denounces-{{ $post->id_publicacao }}" id="motive-denounces-{{ $post->id_publicacao }}" placeholder="{{ __('Explique seu motivo') }}" id="motive-denounces-{{ $post->id_publicacao }}" cols="50" rows="10"></textarea>
              </div>
